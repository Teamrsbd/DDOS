 ...
 */
 ...
 if (process.argv.length < 5){console.log(`Usage: node ERROR420.js URL TIME REQ_PER_SEC THREADS\nExample: node tls.js https://www.error420siam.com/ 500 8 1`); process.exit();}
 ...
 if (cluster.isMaster) {
    ...
    console.log(`
\x1b[38;5;160m      /$$$$$$$  /$$   /$$ /$$$$$$$  /$$   /$$       /$$$$$$$  /$$$$$$$   /$$$$$$   /$$$$$$    
\x1b[38;5;160m     | $$__  $$| $$  | $$| $$__  $$| $$  /$$/      | $$__  $$| $$__  $$ /$$__  $$ /$$__  $$
\x1b[38;5;160m      | $$  \ $$| $$  | $$| $$  \ $$| $$ /$$/       | $$  \ $$| $$  \ $$| $$  \ $$| $$  \__/
\x1b[38;5;160m      | $$  | $$| $$$$$$$$| $$$$$$$/| $$$$$/        | $$  | $$| $$  | $$| $$  | $$|  $$$$$$ 
\x1b[38;5;160m      | $$  | $$|_____  $$| $$__  $$| $$  $$        | $$  | $$| $$  | $$| $$  | $$ \____  $$
\x1b[38;5;160m      | $$  | $$      | $$| $$  \ $$| $$\  $$       | $$  | $$| $$  | $$| $$  | $$ /$$  \ $$
\x1b[38;5;160m      | $$$$$$$/      | $$| $$  | $$| $$ \  $$      | $$$$$$$/| $$$$$$$/|  $$$$$$/|  $$$$$$/
\x1b[38;5;160m     |_______/       |__/|__/  |__/|__/  \__/      |_______/ |_______/  \______/  \______/      `);
    console.log(``);
    console.log(``);
    console.log(`[Broadcast] Attack has sent succesfully `);
    console.log(`[Broadcast] D4RK BOY=RAFI`);
    console.log(`[Broadcast] Contact me https://t.me/D4rk_BoY_RsBd_LeDeR`);
